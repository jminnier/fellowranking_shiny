...
We then take the mean and median of each of these scores across the interviewers and rank each candidate by these scores. We can then sum up a combination of these ranks and use this as the final ordering of candidates. I chose to sum the four ranks based on (1) the mean raw score, (2) the median raw score, and the medians of (3) normalized interviewer scores (score_Inorm) and (4) normalized interviewer ranks (score_Irank).
